    ...
    <>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="flex h-16 items-center justify-between md:h-20">
            ...
            <div className="mr-4 shrink-0">
              <Logo /> {/* Замість компоненту Logo використовуйте ваш університетський логотип */}
            </div>
          </div>
        </div>
      </header>
      ...
      <main className="relative flex grow">
        <div
          ...
          aria-hidden="true"
        >
          <div className="h-80 w-80 rounded-full bg-gradient-to-tr from-green-500 opacity-70 blur-[160px]"></div>
        </div>
